...
class Notifications extends REST_Controller {
    ...
    {
		$response = $this->notification_model->get_new_notifications(
    ...
    {
    	$this->notification_model->remove_in_group(
    		$this->utils->get_user_id(),
    ...
    {
		$response = $this->notification_model->set_all_notifications_read(
			$this->utils->get_user_id()
		);
    ...
    public function list_get()
    {
		...
		$response = $this->notification_model->get_notifications(
			$this->utils->get_user_id(),
			$offset
		);
